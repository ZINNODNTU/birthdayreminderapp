...
class _CalendarViewState extends State<CalendarView> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildDayCell(DateTime day, bool isSelected, bool isToday) {
      ...
      final eventCount = birthdays.where((b) {
      ...
      children: [
        ...
        Card(
          ...
          child: TableCalendar(
            ...
            selectedDayPredicate: (day) => isSameDayAndMonth(_selectedDay, day),
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  leading: b.avatarBase64 != null
                      ? CircleAvatar(
                    radius: 24,
                    backgroundImage:
                    MemoryImage(base64Decode(b.avatarBase64!)),
                  )
                      : CircleAvatar(
                    radius: 24,
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => BirthdayDetailView(birthday: b),
                    ),
                  ),
                ),
              );
